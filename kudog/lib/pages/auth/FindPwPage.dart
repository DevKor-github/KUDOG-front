                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        await changePwService
                                            .requestCode(emailController.text);
                                        if (changePwService.isSend) {
                                          setState(() {
                                            isSend = true;
                                            firstAnswer =
                                                changePwService.firstAnswer;
                                          });
                                        } else {
                                          setState(() {
                                            firstAnswer =
                              ...
                              Row(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                      onTap: () async {
                                        if (isSend) {
                                          await changePwService.verifyEmail(
                          ...
                          child: Column(
                            ...
                            children: [
                              GestureDetector(
                                  onTap: () async {
                                    if (isVerified) {
                                      await changePwService.changePw(
                                          emailController.text,
                                          passwordController.text);
                                      if (changePwService.isSuccess) {
                                        showDialog(
                                            context: context,
                                            builder: (BuildContext context) {
                                              return AlertDialog(
