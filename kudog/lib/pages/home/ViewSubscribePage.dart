...
class _ViewSubscribePageWidgetState extends State<ViewSubscribePageWidget> {
  ...
  void initState() {
    ...
    Provider.of<NoticeService>(context, listen: false).getSubscribedNotices(currentPage);
  }
  ...
  Widget build(BuildContext context) {
    return Consumer2<CategoryService, NoticeService>(
        builder: (context, categoryService, noticeService, child) {
          ...
          List<String> fullLowerCategoryList = categoryService.fullLowerCategoryList;
            isSelected = List.generate(fullLowerCategoryList.length, (index) => false);
              ...
              return Padding(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    color: subIdList.contains(id) ? Color(0xFFCE4040) : Colors
                        .white,
                    border: Border.all(
                      width: 1.0,
                  ...
                  child: Padding(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color:
                        subIdList.contains(id) ? Colors.white : Color(
                            0xFF696969),
                        fontSize: 14,
