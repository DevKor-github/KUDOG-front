...
class FixSubscribePageWidget extends StatefulWidget {
  ...
  @override
  _FixSubscribePageWidgetState createState() =>
      _FixSubscribePageWidgetState();
}
...
class _FixSubscribePageWidgetState extends State<FixSubscribePageWidget> {
  ...
  ElevatedButton _buildSubscriptionButton(int index) {
    String buttonText = subscriptionButtonText[index];
    bool isUpperCategory = index < upperCategories.length;
  ...
  Future<void> saveChanges(List<int> selectedCategoryIds) async {
    print("hello");
    ...
    Map<String, dynamic> requestBody = {
      "subscribeIds": selectedCategoryIds,
      "unsubscribeIds": [],
    };
  ...
  Widget build(BuildContext context) {
    return Consumer<CategoryService> (
      builder: (context, categoryService, child) {
        categoryService.getUpperCategoryList();
                                ...
                                child: Wrap(
                                  ...
                                  children: [
                                    ...
                                    for (int i = 0; i < lowerCategories.length; i++)
                                      _buildSubscriptionButton(upperCategories.length + i),
                                  ],
                                ),
                              ),
                              Container(
