            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    margin : EdgeInsets.fromLRTB(0, 20, 0, 0),
                              ...
                              child: InkWell(
                                ...
                                child: ElevatedButton(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    side: const BorderSide(
                                    width: 1.0,
                                    color: isSelected ? Colors.trasparent : Color(0xFFCDCDCD),
                                    ),
                                  shape: RoundedRectangleBorder(
                                    borderRadius: BorderRadius.circular(208),
                                  ),
                                  backgroundColor: isSelected ? Color(0xFFCE4040) : Colors.white,
                                  ),
                                  child: Text(
                                    "학사일정",
                                    style: TextStyle(
                                      color: isSelected ? Colors.white : Color(0xFF696969),
                                      fontSize: 14,
                                      fontWeight: FontWeight.w500,
                                    ),
                                  ),
